...
import { useNotifications, type NotificationItem } from '../../shared/hooks/use-notifications';
...
export default function NotificationsPage() {
  ...
  const markAsRead = useMutation({
    mutationFn: (notificationId: string) =>
      api.post('/user/api/notifications/mark-notification-as-read', {
        notificationId,
      }),
        ...
        <div className="flex flex-col gap-2">
          {notifications!.map((notification) => (
            ...
            >
              ...
              <div
                className={
                  notification.status === 'unread' ? 'flex-1' : 'flex-1 pl-5'
                }
              >
